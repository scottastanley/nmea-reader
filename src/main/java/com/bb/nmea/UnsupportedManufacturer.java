...
/**
 * UnsupportedManufacturer is the NMEASentence type which is returned if no explicit
 * ProprietarySentenceManufacturer implementation can be found for the manufacturer
 * ID in the provided raw sentence string.
 * 
 * @author Scott Stanley
 */
public class UnsupportedManufacturer extends NMEASentence {
     ...
     */
    public UnsupportedManufacturer(String rawSentence) {
        super(rawSentence);
    }
    ...
    protected String initSentenceId() {
        return "UNSUPPORTED MFG: " + ProprietarySentenceManufacturer.getManufacturerID(getRawSentence());
    }
